...
{   
    ...
    while( receiver.hasWaitingMessages() )
	{
		...
		if ( m.getAddress() == "/a" ) {
            playerList[0].setDirection( m.getArgAsFloat(  0 ) );
		}
        
		if ( m.getAddress() == "/b" ) {
            playerList[0].applyImpulse( m.getArgAsFloat( 0 ) );
		}
    }
...
{    
    ...
    switch(key)
    { 
        case 357: playerList[0].applyImpulse(1); break; //up
        ...
        case 119: playerList[1].applyImpulse(1); break; //w
        ...
        case 121: playerList[2].applyImpulse(1); break; //y
